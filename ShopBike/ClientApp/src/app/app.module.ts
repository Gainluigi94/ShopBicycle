...
import { MatFormFieldModule, MatIcon, MatIconModule, MatInputModule, MatToolbarModule } from '@angular/material';
...
@NgModule({
  declarations: [
    ...
    BikeComponent, ContactComponent
  ...
  imports: [
    ...
    RouterModule.forRoot([
      ...
      { path: 'Buy', component: BikeComponent, pathMatch: 'full' },
